...
isexpected = [
  ...
  { 'n' => '18', 's' => /\A5[.]7[.]1\z/,   'r' => /norelaying/,    'b' => /\A1\z/ },
  { 'n' => '19', 's' => /\A5[.]0[.]0\z/,   'r' => /blocked/,       'b' => /\A1\z/ },
  { 'n' => '20', 's' => /\A5[.]0[.]\d+\z/, 'r' => /onhold/,        'b' => /\d\z/ },
  { 'n' => '21', 's' => /\A5[.]0[.]\d+\z/, 'r' => /networkerror/,  'b' => /\A1\z/ },
  { 'n' => '22', 's' => /\A4[.]0[.]0\z/,   'r' => /systemerror/,   'b' => /\A1\z/ },
  { 'n' => '23', 's' => /\A5[.]1[.]1\z/,   'r' => /userunknown/,   'b' => /\A0\z/ },
  { 'n' => '24', 's' => /\A5[.]0[.]0\z/,   'r' => /userunknown/,   'b' => /\A0\z/ },
  { 'n' => '25', 's' => /\A4[.]4[.]1\z/,   'r' => /expired/,       'b' => /\A1\z/ },
  { 'n' => '26', 's' => /\A5[.]4[.]4\z/,   'r' => /hostunknown/,   'b' => /\A0\z/ },
