...
- changes:
  ...
  - Import sisimai/p5-Sisimai#349
    - Add 2 error code values at `Sisimai::Rhost::FrancePTT`
    - Add 3 sample emails into set-of-emails directory: rhost-franceptt-04.eml,
      05, and 06.
