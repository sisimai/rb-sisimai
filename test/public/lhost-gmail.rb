module LhostEngineTest::Public
  module Gmail
    IsExpected = {
      ...
      '07' => [['5.0.976', '500', 'failedstarttls',  false, false]],
      '08' => [['5.0.947', '',    'expired',         false, false]],
      '09' => [['4.0.947', '',    'expired',         false, false]],
      '10' => [['5.0.947', '',    'expired',         false, false]],
      '11' => [['5.0.947', '',    'expired',         false, false]],
      '15' => [['5.0.947', '',    'expired',         false, false]],
      '16' => [['5.2.2',   '550', 'mailboxfull',     false,  true]],
      '17' => [['4.0.947', '',    'expired',         false, false]],
      '18' => [['5.1.1',   '550', 'userunknown',      true,  true]],
      '19' => [['5.0.922', '',    'mailboxfull',     false, false]],
    }
  end
end
