module LhostEngineTest::Public
  module OpenSMTPD
    IsExpected = {
      ...
      '03' => [['5.9.212', '',    'hostunknown',      true,  true]],
      '04' => [['5.9.341', '',    'networkerror',    false, false]],
      '05' => [['5.9.340', '',    'expired',         false, false]],
      '06' => [['5.9.340', '',    'expired',         false, false]],
      '10' => [['5.9.212', '',    'hostunknown',      true,  true]],
      '11' => [['5.7.26',  '550', 'authfailure',     false, false]],
      '12' => [['5.9.215', '',    'notaccept',        true,  true]],
      '13' => [['4.7.0',   '421', 'badreputation',   false, false]],
      '14' => [['5.7.25',  '550', 'requireptr',      false, false]],
      '15' => [['5.9.340', '',    'expired',         false, false]],
      '16' => [['5.9.340', '',    'expired',         false, false]],
