module LhostEngineTest::Public
  module MailRu
    IsExpected = {
      ...
      '05' => [['5.0.932', '',    'notaccept',        true,  true]],
      '06' => [['5.0.912', '',    'hostunknown',      true,  true]],
      '07' => [['5.0.910', '550', 'filtered',        false,  true]],
      '08' => [['5.0.911', '550', 'userunknown',      true,  true]],
      '09' => [['5.1.8',   '501', 'rejected',        false, false]],
      '10' => [['4.0.947', '',    'expired',         false, false]],
    }
  end
end
